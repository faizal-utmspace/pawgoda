...
/// Staff Customer Bookings Page
/// Shows all bookings for a specific customer
/// Second page in the navigation flow: Customers → Bookings → Activities
class StaffCustomerBookingsPage extends StatefulWidget {
  final String customerId;
  final String customerName;

  const StaffCustomerBookingsPage({
    Key? key,
  ...
  @override
  State<StaffCustomerBookingsPage> createState() =>
      _StaffCustomerBookingsPageState();
}

class _StaffCustomerBookingsPageState extends State<StaffCustomerBookingsPage> {
  ...
  Future<void> _fetchCustomerBookings() async {
    ...
    try {
      // Query bookings by customerId or customerName
      ...
      // If no results, try by customerName
      ...
      for (var doc in snapshot.docs) {
        ...
        fetchedBookings.add({
          ...
          'selectedActivities':
              List<String>.from(data['selectedActivities'] ?? []),
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _fetchCustomerBookings,
          ),
        ],
      ),
      body: SafeArea(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (filter == 'All') {
                    ...
                    count = bookings.where((b) => b['status'] == filter).length;
                  }
  ...
  Widget _buildBookingCard(Map<String, dynamic> booking) {
    ...
    final totalCount = booking['totalActivities'] as int;
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Gap(10),
          Text(
            'This customer has no $selectedFilter bookings',
            style: TextStyle(
              fontSize: 14,
              color: Styles.blackColor.withOpacity(0.6),
            ),
